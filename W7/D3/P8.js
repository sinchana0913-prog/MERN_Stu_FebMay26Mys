//JWT with login,refresh-style logic and secure verification
...
app.post("/login", function (req, res) {
    ...
    const refreshToken = jwt.sign({
        userId: 101,
        email: email,
    },refreshSecretKey,{expiresIn: "10d", algorithm: "HS256", issuer: "jwt-example"}); //d:days m:mins h:hour
...
app.post("/refresh",function(req,res){
    ...
    try{
        ...
        const newAccessToken = jwt.sign({
            ...
            email:decoded.email,
            role:"member"
        },secretKey,{expiresIn: "15m", algorithm: "HS256", issuer: "jwt-example"});
        res.json({
            success:true,
